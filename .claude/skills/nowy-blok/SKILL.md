...
2. Deleguj do agenta **pinegrow-block-expert**: nowy blok wg `Docs/11-konwencje-blokow.md`, wzorowany na istniejących blokach projektu (przekaż mu nazwę, przeznaczenie, ewentualny opis/design od użytkownika).
3. Dodaj demo bloku na `blocks.html` (sekcja katalogu bloków).
